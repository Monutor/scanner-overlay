...
class ArticleLookupButton(
    ...
    private fun resolveInitialX(): Int {
        ...
        return (shelfLeftEdge - buttonSizePx - marginPx).coerceAtLeast(marginPx)
    }
    ...
    private fun launchActivity() {
        val intent = Intent(context, ArticleLookupActivity::class.java).apply {
