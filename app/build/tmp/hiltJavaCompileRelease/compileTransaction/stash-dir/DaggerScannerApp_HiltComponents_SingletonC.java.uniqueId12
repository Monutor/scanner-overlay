...
import com.scanner.overlay.di.AppModule_ProvideSharedPreferencesFactory;
import com.scanner.overlay.overlay.OverlayActivity;
import com.scanner.overlay.overlay.OverlayViewModel;
import com.scanner.overlay.overlay.OverlayViewModel_HiltModules;
import com.scanner.overlay.service.ScannerForegroundService;
import com.scanner.overlay.service.ScannerForegroundService_MembersInjector;
import com.scanner.overlay.settings.SettingsViewModel;
import com.scanner.overlay.settings.SettingsViewModel_HiltModules;
...
public final class DaggerScannerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends ScannerApp_HiltComponents.ActivityC {
    ...
    @Override
    public void injectOverlayActivity(OverlayActivity arg0) {
    }
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(2).put(LazyClassKeyProvider.com_scanner_overlay_overlay_OverlayViewModel, OverlayViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_scanner_overlay_settings_SettingsViewModel, SettingsViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends ScannerApp_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.overlayViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
      this.settingsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put(LazyClassKeyProvider.com_scanner_overlay_overlay_OverlayViewModel, ((Provider) overlayViewModelProvider)).put(LazyClassKeyProvider.com_scanner_overlay_settings_SettingsViewModel, ((Provider) settingsViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.scanner.overlay.overlay.OverlayViewModel 
          return (T) new OverlayViewModel(singletonCImpl.provideSharedPreferencesProvider.get());

          case 1: // com.scanner.overlay.settings.SettingsViewModel 
          return (T) new SettingsViewModel(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule), singletonCImpl.provideSharedPreferencesProvider.get());
  ...
  private static final class ServiceCImpl extends ScannerApp_HiltComponents.ServiceC {
    ...
    @Override
    public void injectScannerAccessibilityService(ScannerAccessibilityService arg0) {
    }

    @Override
    public void injectScannerForegroundService(ScannerForegroundService arg0) {
      injectScannerForegroundService2(arg0);
    }

    private ScannerForegroundService injectScannerForegroundService2(
        ScannerForegroundService instance) {
      ScannerForegroundService_MembersInjector.injectPrefs(instance, singletonCImpl.provideSharedPreferencesProvider.get());
      return instance;
    }
  }
  ...
  private static final class SingletonCImpl extends ScannerApp_HiltComponents.SingletonC {
    ...
    @Override
    public void injectScannerApp(ScannerApp arg0) {
    }
